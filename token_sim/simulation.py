...
class TokenSimulation:
    ...
    def _run_step(self) -> None:
        ...
        # Update price discovery with trading volume
        total_volume = sum(trade['volume'] for trade in trades_this_step)
        ...
        self.history['active_miners'].append(len(self.consensus.get_active_participants()))
